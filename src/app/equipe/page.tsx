    ...
    <>
      <section className="bg-[#3D58F5] text-white py-16 lg:py-20 text-center">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl lg:text-6xl font-bold mb-4">Equipe</h1>
          <p className="text-base lg:text-lg leading-relaxed max-w-2xl mx-auto">
            O VoxDem foi desenvolvido por uma equipe multidisciplinar de pesquisadores e pesquisadoras do ReDem.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white text-black py-16 lg:py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl lg:text-3xl font-bold text-black mb-8">Coordenação</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {coordenacao.map((member) => (
